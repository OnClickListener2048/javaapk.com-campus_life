...
import com.yhx.app.common.JsonCallBack;
import com.yhx.app.common.PageModel;
import com.yhx.app.entity.Item;
...
public class MyLookActivity extends Activity implements UpdateHandler {
    ...
    private static int REQUEST_RESULT_CODE = 0x0029;
    private List<ItemList> mPageModelData;
    ...
    private void loadInfo(String type) {
        OkGo.<String>post(Constants.URL + "/second-hand/shop_info.do")
                .params("value",type)
                .params("pageNo",1)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if (body!=null&& !"".equals(body)) {
                            PageModel<ItemList> pageModel = PageModel.jsonConvert(body);
                            popUpWondow(pageModel);
                        }
                    }
                });
    }

    private void popUpWondow(PageModel<ItemList> pageModel) {
        PopupWindow popupWindow = new PopupWindow(LayoutInflater.from(MyLookActivity.this).inflate(R.layout.simple_listview, null), ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, true);
        popupWindow.setHeight((int) (ScreenUtils.getScreenHeight() * 0.7));
        popupWindow.setWidth((int) (ScreenUtils.getScreenWidth() * 0.75));
        ...
        mPageModelData = pageModel.getData();
        shopListAdapter.setItemList(mPageModelData);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                LogUtils.d("position"+i);
                    ItemList itemList = mPageModelData.get(i-1);
