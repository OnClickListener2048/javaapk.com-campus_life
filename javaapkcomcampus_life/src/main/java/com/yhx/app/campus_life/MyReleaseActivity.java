...
public class MyReleaseActivity extends Activity implements UpdateHandler {
	...
	private static int REQUEST_RESULT_CODE = 0x0030;
	...
	private void loadInfo(String type) {
		LogUtils.d("loadInfo");
		OkGo.<String>post(Constants.URL + "/second-hand/look_list.do")
				.params("value",type)
				.params("pageNo",1)
	...
	private void popUpWondow(PageModel<ItemList> pageModel) {
		LogUtils.d("popUpWondow");
		PopupWindow popupWindow = new PopupWindow(LayoutInflater.from(MyReleaseActivity.this).inflate(R.layout.simple_listview, null), ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, true);
